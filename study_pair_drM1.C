{
  ...
  TFile* file_d = new TFile("JPsi_17Nov2017_Charmonium_Run2017v1_Full_GoldenJSON_MMAll.root");
  TChain* tree = (TChain*) file_d->Get("tpTree/fitter_tree");
  ...
  TFile* file_m = new TFile("JPsi_94X_JpsiToMuMu_Pythia8_MM.root");
